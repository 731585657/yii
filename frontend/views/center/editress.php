...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li><?=Yii::$app->user->identity?Yii::$app->user->identity->username:'游客'?></li>
...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                <dt> <?=$user['username']?>&emsp;
                 <?=$user['purpose']?>&emsp;
                 <?=$user['tal']?></dt>
                <dd>
                    <a href="<?=\yii\helpers\Url::to(['center/edit','id'=>$user['id']])?>">修改</a>
            ...
            <form action="" name="address_form" method="post">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="tals" class="txt" />
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="statuss" class="check" value="1"/>设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
