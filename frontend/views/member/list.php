...
<div class="list w1210 bc mt10">
	...
	<div class="list_bd fl ml10 mt10">
		...
		<div class="goodslist mt10">
			<ul>
				<?php
                        foreach ($goods as $good):  //var_dump($good->logo);exit;
                    ?>
				<li>-
					<dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['member/goods', 'id'=>$good['id']])?>"><img src="<?=$good->logo?>" alt="" /></a></dt>
						<dd><a href="<?=\yii\helpers\Url::to(['member/goods', 'id'=>$good['id']])?>"><?=$good->name?></a></dt>
