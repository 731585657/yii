...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.php"><img src="/images/logo.png" alt="京西商城"></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <?php foreach ($menus as $menu1): ?>
                    <div class="cat item1">
                        <h3><a href="###"><?=$menu1['name']?></a> <b></b></h3>
                        <div class="cat_detail">

                            <?php foreach ($menu1['parent_id'] as $menu2): ?>
                                <dl class="dl_1st">
                                    <dt><a href="<?=\yii\helpers\Url::to(['member/list', 'id'=>$menu2['id']])?>"><?=$menu2['name']?></a></dt>
                                    <?php foreach ($menu2['parent_id'] as $menu3): ?>
                                        <dd>
                                            <a href="<?=\yii\helpers\Url::to(['member/list', 'id'=>$menu3['id']])?>"><?=$menu3['name']?></a>
                                        </dd>
                                    <?php endforeach; ?>
                                </dl>
                            <?php endforeach; ?>
