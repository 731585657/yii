	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to([''])?>">登录</a>] [<a href="register.html">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
		...
		<table>
            ...
            <?php foreach ($models as $model):?>
				<tr data-id="<?=$model->id?>">
					...
					<td class="col6"><a href="javascript:;" class="del_sum">删除</a></td>
				</tr>
            <?php
                $total += ($model->shop_price)*$carts[$model->id];
            endforeach;?>
			</tbody>
			<tfoot>
				<tr>
