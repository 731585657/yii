...
<div class="fillin w990 bc mt15">
        ...
        <div class="address">
            ...
            <div class="address_info">
                <?php foreach ($address as $address1):?>
                    <p><input type="radio" value="<?=$address1['id']?>" name="address" checked=""/><?=$address1['username']?> <?=$address1['province']?> <?=$address1['city']?> <?=$address1['area']?> <?=$address1['address']?> <?=$address1['tal']?> </p>
                <?php endforeach;?>
            </div>
            ...
            <table>
                ...
                <?php foreach($goods as $good):?>
                    <tr>
                        ...
                        <td class="col4"> <?=$num?></td>
                        <td class="col5">￥<span><?=sprintf("%.2f",$good['shop_price']*$num)?></span></td>
                    </tr>
                <?php
                    $total+=$good['shop_price']*$num;
                endforeach;?>
    ...
    <div class="fillin_ft">
        ...
        <p>应付总额：<strong  id="pricess">￥<?=$total?></strong></p>
